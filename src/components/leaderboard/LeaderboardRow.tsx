...
export const LeaderboardRow = memo(
  ...
  (prev, next) =>
    prev.entry.total_score === next.entry.total_score &&
    prev.entry.rank === next.entry.rank &&
    prev.entry.problems_solved === next.entry.problems_solved &&
    prev.isCurrentUser === next.isCurrentUser &&
    prev.isRecentlyUpdated === next.isRecentlyUpdated &&
    prev.isNewTopTen === next.isNewTopTen &&
    prev.maxScore === next.maxScore &&
    prev.change?.direction === next.change?.direction &&
    prev.change?.scoreDelta === next.change?.scoreDelta,
);
