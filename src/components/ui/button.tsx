  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-transparent text-foreground hover:bg-secondary hover:border-border-active",
        secondary:
        ...
        // CodeArena specific variants
        arena:
          "bg-primary text-primary-foreground font-semibold shadow-glow hover:bg-primary-hover hover:shadow-lg active:scale-[0.98]",
        "arena-outline":
          "border-2 border-primary bg-transparent text-primary font-semibold hover:bg-primary/10 hover:shadow-glow",
        "arena-secondary":
          "bg-secondary border border-border text-foreground font-medium hover:bg-secondary-hover hover:border-border-active",
        "arena-accent":
          "bg-accent text-accent-foreground font-semibold hover:bg-accent-hover shadow-glow-accent",
        success:
          "bg-success text-success-foreground font-medium hover:bg-success/90",
        warning:
